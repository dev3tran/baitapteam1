...
import { WhenAChildIsBornStyled, WrapTitle, Title, ContentError, TitleError, WrapError, WrapTitleError } from './styled';
import { IconChildPaint, IconExclamation } from '../../../../atoms/icons';

export const WhenAChildIsBornError = (): JSX.Element => {
  return (
