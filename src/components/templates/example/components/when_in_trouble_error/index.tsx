...
import { WhenInTroubleStyled, WrapTitle, Title, ContentError, TitleError, WrapError, WrapTitleError } from './styled';
import { IconAccessibility, IconExclamation } from '../../../../atoms/icons';

export const WhenInTroubleError = (): JSX.Element => {
  return (
    <WhenInTroubleStyled>
      <WrapTitle>
