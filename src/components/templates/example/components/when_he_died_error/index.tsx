...
import { WhenHeDiedStyled, WrapTitle, Title, WrapError, ContentError, TitleError, WrapTitleError } from './styled';
import { IconAngel } from '../../../../atoms/icons';
import { IconExclamation } from '../../../../atoms/icons';

export const WhenHeDiedError = (): JSX.Element => {
  return (
    <WhenHeDiedStyled>
      <WrapTitle>
